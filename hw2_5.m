...
while ~isempty(A)
    ...
    if cur(1)>1 && cur(1)<length(edge_candidate)-1 && cur(2)>1 && cur(2)<length(edge_candidate)-1
        if edge_candidate(cur(1)-1,cur(2)-1) > low && result(cur(1)-1,cur(2)-1) == 0
            A = [A; cur(1)-1 cur(2)-1];
        elseif edge_candidate(cur(1)-1,cur(2)) > low && result(cur(1)-1,cur(2)) == 0
            A = [A; cur(1)-1 cur(2)];
        elseif edge_candidate(cur(1)-1,cur(2)+1) > low && result(cur(1)-1,cur(2)+1) == 0
            A = [A; cur(1)-1 cur(2)+1];
        elseif edge_candidate(cur(1),cur(2)-1) > low && result(cur(1),cur(2)-1) == 0
            A = [A; cur(1) cur(2)-1];
        elseif edge_candidate(cur(1),cur(2)+1) > low && result(cur(1),cur(2)+1) == 0
            A = [A; cur(1) cur(2)+1];
        elseif edge_candidate(cur(1)+1,cur(2)-1) > low && result(cur(1)+1,cur(2)-1) == 0
