...
R = 20;
SSDth = 100;
corsSSD = naiveCorrespondanceMatching(warrior01, warrior02, corners_1, corners_2, R, SSDth);
...
epiLine_2 = [];
for i = 1:size(cor1, 1)
    line_1 = linePts(FMatrix' *[cor2(i,:),1]', [1, size(warrior01, 2)], [1, size(warrior01, 1)]);
    epiLine_1 = [epiLine_1; line_1(1,:), line_1(2,:)];
    line_2 = linePts(FMatrix  *[cor1(i,:),1]', [1, size(warrior02, 2)], [1, size(warrior02, 1)]);
    epiLine_2 = [epiLine_2; line_2(1,:), line_2(2,:)];
end
...
epiLine_2 = [];
for i = 1:size(cor1, 1)
    line_1 = linePts(FMatrix' *[cor2(i,:),1]', [1, size(matrix01, 2)], [1, size(matrix01, 1)]);
    epiLine_1 = [epiLine_1; line_1(1,:), line_1(2,:)];
    line_2 = linePts(FMatrix  *[cor1(i,:),1]', [1, size(matrix02, 2)], [1, size(matrix02, 1)]);
    epiLine_2 = [epiLine_2; line_2(1,:), line_2(2,:)];
end
...
R = 20;
SSDth = 90;
corsSSD = correspondanceMatchingLine(warrior01, warrior02, corners_1, FMatrix, R, SSDth);
...
R = 20;
SSDth = 2000;
corsSSD = correspondanceMatchingLine(matrix01, matrix02, corners_1, FMatrix, R, SSDth);
...
outlierTH = 20;
[inlier, outlier] = findOutliers(points3D, proj_warrior02, outlierTH, corsSSD);
...
outlierTH = 20;
[inlier, outlier] = findOutliers(points3D, proj_matrix02, outlierTH, corsSSD);
